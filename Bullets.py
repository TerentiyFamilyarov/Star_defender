...
def update_bullets_list():
    ...
    bullets = [
        ('Default',   (1*damage_koef),  (13 * speed_koef),int(1*speed_shoot_koef),   int(10 * scale_x_koef),int(3 * scale_y_koef), 'arrow_right.png'),
        ('Chaos',     (0.5*damage_koef),(5 * speed_koef), int(1*speed_shoot_koef),int(4 * scale_x_koef), int(4 * scale_y_koef), 'arrow_right.png'),
        ('Navigation',(5*damage_koef),  (2 * speed_koef), int(4*speed_shoot_koef), int(5 * scale_x_koef), int(6 * scale_y_koef), 'arrow_right.png'),
    ]
    damage.clear()
    step.clear()
    speed_shoot.clear()
